...
class BrokeragesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create brokerage" do
    assert_difference('Brokerage.count') do
      post brokerages_url, params: { brokerage: { logo_url: @brokerage.logo_url, name: @brokerage.name } }
    end
  ...
  test "should update brokerage" do
    patch brokerage_url(@brokerage), params: { brokerage: { logo_url: @brokerage.logo_url, name: @brokerage.name } }
